    ...
    <>
      ...
      <main>
        <section className="hero" aria-labelledby="page-title">
          ...
          <CharacterStage />
          <p className="instruction"><span className="desktop-instruction">창, 방패, 장갑, 신발을 선택해 보세요. Tab 키로도 살펴볼 수 있습니다.</span><span className="touch-instruction">캐릭터의 장비를 탭해 보세요.</span></p>
